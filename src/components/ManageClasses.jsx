    ...
    return savedClasses ? JSON.parse(savedClasses) : [
      {
        ...
        teacherId: 'Ahmet Öğretmen',
        students: [
          { id: 'alice', name: 'Ayşe Yılmaz', email: 'ayse@student.com', status: 'active', gender: 'female' },
          { id: 'bob', name: 'Mehmet Demir', email: 'mehmet@student.com', status: 'active', gender: 'male' },
          { id: 'charlie', name: 'Fatma Kaya', email: 'fatma@student.com', status: 'active', gender: 'female' },
          { id: 'diana', name: 'Ahmet Öztürk', email: 'ahmet@student.com', status: 'active', gender: 'male' },
          { id: 'edward', name: 'Zeynep Şahin', email: 'zeynep@student.com', status: 'active', gender: 'female' },
          { id: 'fiona', name: 'Mustafa Çelik', email: 'mustafa@student.com', status: 'active', gender: 'male' },
          { id: 'george', name: 'Emine Arslan', email: 'emine@student.com', status: 'inactive', gender: 'female' },
          { id: 'hannah', name: 'Ali Koç', email: 'ali@student.com', status: 'active', gender: 'male' },
          { id: 'ian', name: 'Hatice Güler', email: 'hatice@student.com', status: 'inactive', gender: 'female' },
          { id: 'julia', name: 'Hüseyin Aydın', email: 'huseyin@student.com', status: 'active', gender: 'male' },
          { id: 'kevin', name: 'Meryem Polat', email: 'meryem@student.com', status: 'active', gender: 'female' },
          { id: 'lisa', name: 'Osman Erdoğan', email: 'osman@student.com', status: 'inactive', gender: 'male' }
        ]
      },
      {
        id: 'classB',
